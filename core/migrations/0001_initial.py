# Generated by Django 6.0.6 on 2026-06-19 16:36
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="acquisition",
                to="core.spectrometerparameters",
            ),
        ),
        migrations.CreateModel(
            name="User",
            fields=[
                ...
                (
                    "file_proposal",
                    models.FileField(
                        blank=True, null=True, upload_to="users/proposals/"
                    ),
                ),
                (
                    "file_retex",
                    models.FileField(blank=True, null=True, upload_to="users/retex/"),
                ),
                (
                    "laboratory",
                    models.ForeignKey(
